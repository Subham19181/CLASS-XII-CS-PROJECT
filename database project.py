...
while bank==1:
    print('>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>')
    print("WELCOME TO BANK OF ADITYA ONLINE PORTAL")
    print('>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>')
    ...
    if choice==1:
        def welcome_message():
            print('>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>')
            print('WELCOME TO BANK OF ADITYA')
            print('>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>')
                    ...
                    if ch==1:
                        ...
                        if condition=='false':
                            ...
                            if cho==1:
                                ...
                                print("Bank of Aditya charges an Interest of 7% on loans")
                        ...
                        if condition=='false':
                            ...
                            if cho==1:
                                ...
                                if ty=='car':
                                    ...
                                    print("Bank of Aditya gives Insurance for cars of: ",ins)
                                    ...
                                    print('>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>')
                                    ina=((ins/5)/15)
                                    print("Bank of Aditya gives Insurance for bikes of: ",ins)
                                    print("Your Requested Insurance Claim Amount has to be paid yearly")
                                    print("Amount to pay the for Insurance Claim Amount per year: ",ina)
                                    loa=input("Do you want to continue the Insurance Claim application? (y/n): ")
                                    if loa=='y':
                                ...
                                print('>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>')
                                ina=(ins/12)-(ins/20)
                                print("Bank of Aditya gives Life Insurance of: ",ins)
                                print("Your Requested Insurance Claim Amount has to be paid yearly")
                                print("Amount to pay the for Insurance Claim Amount per year: ",ina)
                                loa=input("Do you want to continue the Insurance Claim application? (y/n): ")
                                if loa=='y':
                                ...
                                print('>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>')
                                ina=(ins/12)/7
                                print("Bank of Aditya gives Property Insurance of: ",ins)
                                print("Your Requested Insurance Claim Amount has to be paid yearly")
                                print("Amount to pay the for Insurance Claim Amount per year: ",ina)
                                loa=input("Do you want to continue the Insurance Claim application? (y/n): ")
                                if loa=='y':
                                ...
                                print('>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>')
                                ina=(ins/12)/7
                                print("Bank of Aditya gives Business Liability Insurance of: ",ins)
                                print("Your Requested Insurance Claim Amount has to be paid yearly")
                                print("Amount to pay the for Insurance Claim Amount per year: ",ina)
                                loa=input("Do you want to continue the Insurance Claim application? (y/n): ")
                                if loa=='y':
